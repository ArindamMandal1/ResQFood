...
export default function Signup() {
  ...
  function validate() {
    ...
    if (!form.password || form.password.length < 8) err.password = "Password min 6 chars";
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-sm text-slate-500">Join ResQFood as a restaurant or NGO partner</div>
              </div>
            </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input name="password" type="password" value={form.password} onChange={handleChange}
                className="w-full mt-1 px-3 py-2 border rounded-lg" placeholder="password" />
